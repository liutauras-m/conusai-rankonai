      ...
      {analysis.metadata && (
        <section className="grid gap-3 sm:grid-cols-2">
          <div className="rounded-xl border border-border/50 bg-card p-4">
            <p className="font-medium text-muted-foreground text-xs uppercase tracking-wider">Page Title</p>
            <p className="mt-1.5 text-foreground text-sm leading-relaxed">
              {analysis.metadata.title?.value || <span className="text-muted-foreground italic">Not set</span>}
            </p>
          </div>
          <div className="rounded-xl border border-border/50 bg-card p-4">
            <p className="font-medium text-muted-foreground text-xs uppercase tracking-wider">Meta Description</p>
            <p className="mt-1.5 line-clamp-3 text-foreground text-sm leading-relaxed">
              {analysis.metadata.description?.value || <span className="text-muted-foreground italic">Not set</span>}
            </p>
          </div>
        </section>
      )}
