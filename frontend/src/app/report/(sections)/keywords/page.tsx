    ...
    <div className="space-y-6">
      ...
      <section className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-medium text-muted-foreground text-sm uppercase tracking-wider">Top Keywords</h2>
        </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative flex items-center gap-2">
                      ...
                      <span className="font-medium text-foreground text-sm tabular-nums">{keyword.count}</span>
                    </div>
                  </div>
                )
              })}
